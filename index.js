let datas = [
    ...
    },
    {
        id:2,
        image_url:
        "https://images.firstpost.com/wp-content/uploads/2022/08/Dinesh-Karthik-Rishabh-Pant.jpg?impolicy=website&width=640&height=362",
        name:"CRICKET Rishabh Pant or Dinesh Karthik: India vs South Africa T20Is likely to settle the wrangling debate",
        mainPara:"Dinesh Karthik and Rishabh Pant have not got enough game time ahead of the T20 World Cup and the South Africa T20I series is their only chance to impress the India management before the Men in Blue travel to Australia.",
        linkPage:"cricket.html",
        para2:"Team India’s T20I series against South Africa is their last chance to fine-tune the squad and test combinations ahead of the T20 World Cup 2022, which is scheduled to begin from 16 October. With Hardik Pandya and Bhuvneshwar Kumar rested, the likes of Rishabh Pant and others are in contention to play in what is the final run of games heading into the month-long T20 spectacle in Australia.",
        para3:"India skipper Rohit Sharma will have to nurse a selection headache for the T20I series against the Proteas considering that this is also the last chance for some players to get some match time before the much-awaited T20 World Cup.",
        para4:"Both Dinesh Karthik and Rishabh Pant are part of India’s T20 World Cup squad and with both of them playing the same role of wicketkeeper-batter, it is highly probable that only one between the two will be picked in the playing XI for the marquee event.",
        para5:"Hence, the big question which still haunts the Team India management is – Pant or Karthik? Which player is suitable for their lineup?",
        para6:"Karthik and Pant have not got enough game time ahead of the T20 World Cup and the same was acknowledged by pack leader Rohit Sharma after the recently-concluded T20I series against Australia.",
        para7:"“It depends on the situation. I obviously wanted these guys to have a number of games under their belt before the World Cup. When we went to the Asia Cup, both these guys were in the fray to play all the games or whenever there is an opportunity or if there is a tactical matchup, we can bring in those guys. But I just feel that Dinesh needs a little more game time, so does Pant,” Rohit said during a press conference.",
        para8:"“Honestly speaking, Pant needs some game time as well. But looking at how this series was important for me to just stick to that consistent batting lineup,” said Sharma during the post-match press conference after India defeated Australia by six wickets in the third T20I here on Sunday to win the series 2-1.",
    ...
    },
    {
        ...
        para8:"https://twitter.com/LaverCup/status/1574094503178297349?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1574094503178297349%7Ctwgr%5Ed44da33c54929a9ebfbd06b4be1cfd1cf805d867%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fwww.firstpost.com%2Fsports%2Ftennis-news%2Fwatch-roger-federer-confirms-he-will-be-there-at-2023-laver-cup-11332491.html",
...
datas.forEach(function (el){
    ...
    card.append(newsImg, heading, mainParas);
...
datas2.forEach(function (el){
    ...
    document.querySelector("#container-left").append(card2);
