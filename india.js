let indiaData=[
    {
        id:3,
        image_url:"https://images.firstpost.com/wp-content/uploads/2022/09/LC1.jpg?impolicy=website&width=640&height=363",
...
indiaData.forEach(function (el){
    ...
    card.append(heading, mainParas, newsImg, paras2, paras3, paras4, paras5, paras6, paras7);
    document.querySelector("#india-left").append(card);
...
datas2.forEach(function (el){
    ...
    document.querySelector("#india-right").append(card2);
